...
| D2 source binding and canonical manifest | #27 binding (**applied**); the SourceBinding shape and decode bounds by #23, the hex/coupling checks (V3-C1/C2) by #24, the canonical manifest computation by #27 |
| D3 per-kind verification rules, reason codes, knobs | #24 verifier (**applied**) |
| D4 Replace extension and reaffirmation | #24 verifier (**applied**) |
| D5 Selection approval binding | #25 verifier (**applied**) |
| D6 standing | #26 replay (**applied**) |
| D7 report and receipt text | #26 replay (**applied**) |
