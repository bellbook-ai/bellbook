...
The corpus triggers 25 of the 28 `ReasonCode` variants as verdicts. The other
...
The `conformance` test asserts that the 25 wire-expressible verdict reasons each
