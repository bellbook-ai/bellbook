...
The corpus triggers 24 of the 27 `ReasonCode` variants as verdicts. The other
...
The `conformance` test asserts that the 24 wire-expressible verdict reasons each
